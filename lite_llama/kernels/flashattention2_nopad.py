...
def run_flash_attention2_no_pad_benchmark(
    ...
    b_seq_len = torch.tensor([512, 1024, 512, 1024], dtype=torch.int32, device="npu:6")
    b_start_loc = torch.tensor([0, 512, 1536, 2048], dtype=torch.int32, device="npu:6")
    ...
    for seq_len in max_seq_len_list:
        ...
        b_start_loc = torch.tensor(
            [0, seq_len, 2 * seq_len, 3 * seq_len], dtype=torch.int32, device="npu:6"
        )  # batch = 4
