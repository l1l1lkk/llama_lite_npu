...
Current v0.0.12rc3 changes are scheduler and sampling-path changes. The release
...
- [v0.0.12rc3 Release Report](docs/releases/v0.0.12rc3.md) - adaptive chunked prefill and scheduler policy.
