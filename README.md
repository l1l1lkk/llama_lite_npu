...
Current v0.0.12rc2 changes are scheduler and sampling-path changes. The release
...
- [v0.0.12rc2 Release Report](docs/releases/v0.0.12rc2.md) - adaptive chunked prefill and scheduler policy.
