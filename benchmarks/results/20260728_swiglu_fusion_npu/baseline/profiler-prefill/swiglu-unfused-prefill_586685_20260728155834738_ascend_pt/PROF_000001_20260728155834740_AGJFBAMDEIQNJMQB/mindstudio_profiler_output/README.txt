...
2.npu_mem.csv:NPU memory usage data.
...
6.hbm.csv:HBM memory read/write speed.
7.api_statistic.csv:Time spent by AscendCL API, is used to collect statistics on the time spent by API execution at the CANN layer.
	Level: Level of an API, including AscendCL, Runtime, Node, Model, and Communication.
8.op_summary.csv:AI Core, AI CPU, AI Vector and COMMUNICATION communication operator data,is used to collect statistics on operator details and time consumptions.
...
9.npu_module_mem.csv:Here is no description about this file: npu_module_mem, please check in 'Profiling Instructions'!
