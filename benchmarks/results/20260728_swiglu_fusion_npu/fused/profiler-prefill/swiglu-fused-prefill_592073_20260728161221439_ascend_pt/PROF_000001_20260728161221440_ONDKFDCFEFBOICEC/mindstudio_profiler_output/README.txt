...
3.llc_read_write.csv:L3 cache read/write speed.
...
6.npu_module_mem.csv:Here is no description about this file: npu_module_mem, please check in 'Profiling Instructions'!
7.hbm.csv:HBM memory read/write speed.
8.op_statistic.csv:AI Core and AI CPU operator calling times and time consumption.
