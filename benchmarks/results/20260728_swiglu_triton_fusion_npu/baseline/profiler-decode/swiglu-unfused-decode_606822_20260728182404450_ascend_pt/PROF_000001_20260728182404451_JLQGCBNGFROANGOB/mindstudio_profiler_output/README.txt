...
5.npu_mem.csv:NPU memory usage data.
...
7.op_statistic.csv:AI Core and AI CPU operator calling times and time consumption.
...
8.npu_module_mem.csv:Here is no description about this file: npu_module_mem, please check in 'Profiling Instructions'!
9.hbm.csv:HBM memory read/write speed.
