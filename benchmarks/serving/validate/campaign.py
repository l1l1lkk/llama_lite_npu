...
CLIENT_PROFILE_FIELDS = (
    ...
    "evalscope_perf.extra",
    "evalscope_perf.help_status",
    "evalscope_perf.entrypoint_import_status",
    "evalscope_perf.entrypoint_modules",
    "evalscope_perf.applicable_requirements",
