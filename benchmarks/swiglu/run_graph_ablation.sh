#!/usr/bin/env bash
# Run the unfused/fused x NPU Graph off/on serving ablation.
...
BASELINE_CHECKOUT=${BASELINE_CHECKOUT:-/data/liuke/llama_lite_npu-worktrees/swiglu-unfused-baseline}
FUSED_CHECKOUT=${FUSED_CHECKOUT:-/data/liuke/llama_lite_npu-worktrees/swiglu-fused-optimization}
RESULT_ROOT=${1:-/data/liuke/swiglu_graph_validation_20260728/four-quadrant}
PORT=${PORT:-8016}
...
declare -A BRANCHES=(
  [baseline]=test/swiglu-unfused-baseline
  [fused-triton]=feature/swiglu-fused-optimization
)
